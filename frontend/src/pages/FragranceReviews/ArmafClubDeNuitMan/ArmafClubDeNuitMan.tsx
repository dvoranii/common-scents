  ...
  return (
    <PageWrapper>
      ...
      <IntroSection>
        ...
        <ParagraphWrapper>
          <Paragraph>
            <strong>Armaf Club de Nuit Man</strong> is the often-overlooked gem
            in Armaf's lineup that brilliantly captures the Paco Rabanne 1
      ...
      <ReviewSection>
        ...
        <ParagraphWrapper>
          ...
          <NotesList>
            ...
            <li>
              ...
              leather accord that gives it that "money" vibe. The rose is subtle
              but adds sophistication, while the spice keeps it masculine and
              intriguing.
            </li>
            <li>
              <strong>Base Notes (4+ hours):</strong> The dry down settles into
              a warm, amber and patchouli base with that signature sweetness
              lingering throughout. It's less complex than 1 Million but
              maintains the same overall vibe. The base lasts incredibly well
              and becomes quite addictive.
            </li>
          </NotesList>
        </ParagraphWrapper>
        ...
        <ParagraphWrapper>
          ...
          <Paragraph>
            ...
            on skin easily, and I've detected it on clothes 2 days later. For a
            $25 fragrance, this performance is almost comical. It outlasts many
            fragrances costing 5x more.
          </Paragraph>
          <Paragraph>
            <strong>Projection (8/10):</strong> Massive projection for the first
            3-4 hours. This is not a shy fragrance—it will fill a room. After
            the initial blast, it settles into a strong 3-4 foot bubble that
            lasts for hours before becoming a skin scent.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            the best value propositions in cloning. You're getting 85-90% of the
            1 Million experience with better longevity than current 1 Million
        ...
        <ParagraphWrapper>
          ...
          <Paragraph>
            ...
            afraid to be the center of attention and you appreciate good value.
            You might be a student or young professional who wants
            designer-level presence on a budget.
          </Paragraph>
          <Paragraph>
            Pair this with: night-out attire—dark jeans, fitted shirts, leather
            jackets, or stylish streetwear. This is for when you're trying to
            make an impression, not for when you're trying to blend in.
          </Paragraph>
        </ParagraphWrapper>
        ...
        <ParagraphWrapper>
          <Paragraph>
            ...
            (literally) that mass audiences love. I've gotten multiple "you
            smell good" comments every time I've worn it out at night. Friends
            have asked what I'm wearing, then been shocked at the price.
          </Paragraph>
          <Paragraph>
            That said, it's not for everyone. The sweetness can be overwhelming
            for some, and the synthetic opening might bother fragrance snobs.
            But for the average person you'll encounter at bars or parties, it's
        ...
        <ParagraphWrapper>
          ...
          <Paragraph>
            ...
            office-appropriate or versatile. If you're over 35 and want
            something more mature and sophisticated.
          </Paragraph>
          <Paragraph>
            <strong>My Rating: 4/5</strong> - Points deducted for the synthetic
            opening and lack of versatility. But for what it aims to be—a budget
            1 Million clone with nuclear performance—it's incredibly successful
            and arguably one of Armaf's most underrated releases.
          </Paragraph>
        </ParagraphWrapper>
      </ReviewSection>
    </PageWrapper>
